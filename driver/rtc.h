...
#define tai_to_utc_date(td)   ( td + get_leapseconds_tai(td) )
#define local_to_utc_date(ld) ( ld + get_offset_local   (ld) )
#define utc_to_local_date(ud) ( ud + get_offset_utc     (ud) )
#define tai_to_local_date(ld) ( utc_to_local_date ( tai_to_utc_date (ld) ) )
#define local_to_tai_date(ud) ( utc_to_tai_date ( local_to_utc_date (ud) ) )
